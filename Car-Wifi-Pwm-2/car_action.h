...
#include"pwm.h"        //调用延迟_串口模块
extern void Motor(int L_oriention,int R_oriention);
...
void Action()		//瞬时动作
{
	switch(sign)
	{
		case 1:
		{
			P1=0x33;
			Delayms(200);
			Motor(0x31,0x32);	//0011  0001/0010
			//Delayms(main_time);
			EN_L=0;
			EN_R=0;
			break;
		...
		case 2:
		{
			Motor(0x38,0x34);	//0011  1000/0100
			//Delayms(main_time);
			EN_L=0;
			EN_R=0;
			break;
		...
		case 3:
		{
			Motor(0x30,0x32);	//0011  0000/0010
			//Delayms(main_time);
			EN_L=0;
			EN_R=0;
			break;
		...
		case 4:
		{
			Motor(0x31,0x30);	//0011  0001/0000
			//Delayms(main_time);
			EN_L=0;
			EN_R=0;
			break;
